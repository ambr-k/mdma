...
pub fn search() -> HTML {
    // https://fontawesome.com/icons/magnifying-glass
    // html! { ."h-4"."w-4" {} };
    PreEscaped(
...
pub fn open_external() -> HTML {
    // https://uxwing.com/popup-link-icon/
    PreEscaped(
        r#"<svg class="h-6 w-6 fill-current" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 509 511.54">
